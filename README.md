<h1 align="center">Hi there, I'm Shaqib 👋</h1> <p align="center"> <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&pause=1000&color=00F7FF&center=true&vCenter=true&width=600&lines=Software+Engineer+%7C+Backend+%2B+Cloud;Building+with+Django+%26+FastAPI;Exploring+LLMs+and+RAG-based+AI+Agents;Always+Learning+%7C+Always+Shipping" alt="Typing SVG" /> </p> <p align="center"> <img src="https://capsule-render.vercel.app/api?type=waving&color=0:00F7FF,100:7B2FFF&height=180&section=header&text=Welcome%20to%20my%20Profile&fontSize=38&fontColor=ffffff&animation=fadeIn" /> </p>
🚀 About Me
🔭 Software Engineer passionate about Backend, Cloud, and AI
🌱 Currently deep-diving into Django and DevOps
